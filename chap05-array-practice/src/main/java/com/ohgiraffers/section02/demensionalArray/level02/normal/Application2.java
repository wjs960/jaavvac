...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        for (int k =0; k < one.length; k++){
            for (int j =0; j < one[k].length;j++){
                System.out.print(one[k][j]);
                System.out.print(" ");
            }
            System.out.println();
        }
        ...
        for (int k =0; k < two.length; k++){
            for (int j =0; j < two[k].length;j++){
                System.out.print(two[k][j]);
                System.out.print(" ");
            }
            System.out.println();
        }
